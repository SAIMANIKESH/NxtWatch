      ...
      <div className="trending-success-view-container">
        <TitleContainer dark={dark}>
          <ReactIconBackgroundColor dark={dark}>
            <SiYoutubegaming size={35} color="#ff0000" className="react-icon" />
          </ReactIconBackgroundColor>
          <MainHeading dark={dark}>Gaming</MainHeading>
        </TitleContainer>
          ...
          return (
            <NormalContainer>
              ...
              <div className="home-container">
                <Sidebar location="Gaming" />
                <div className="home-info-container">
                  <PremiumAd />
                  <TrendingContainer data-testid="gaming" dark={dark}>
